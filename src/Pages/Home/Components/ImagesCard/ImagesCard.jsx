...
<div  className="main-container h-auto bg -[#fbfbfb] w-full mt-[85px] relative  ">
     ...
     <div className="swiper-container mt-8 px-2  sm:mt-20 animate-section opacity-0 transition-opacity duration-1000 ">
        ...
        >
          ...
          <SwiperSlide>
            <div className="flex relative w-full h-[270px] transition-transform duration-300 hover:scale-90 bg-[url(https://s3-alpha-sig.figma.com/img/7457/69e9/eec30ec0783fa56a574d2f8a05000975?Expires=1735516800&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=Wj8EDHw3raZolus4PYA9H4vUAjSAJCgnNsLvYDhiOLr6R1yQ7e6jyKFaorqVDdmxm2zki0C3VccBKBCb5SZrXN6I2y7hBwWnfnyBEURhBSS294doDkQ~IRBJcT3AfqTfhrVRjSsey-VKp0gpFuacMvUiTDcZ~Pi9YPhRXY5d5sq6noOsSUkbvF1x2Bix7dV2siaMx~Wh68U7GFCl0EK70jX632btIuOqdtyNWUHGJ2tjY05~uxuTRz3KyyXZrzYqXrp9hDhBfMNAyLw9V4btGqFhqQDFxATEcnpYGJQatS~I4BzkF6s23MEpVF9LyoUSHpQSnk~dun7sG1IOlJhCHA__)] bg-cover bg-no-repeat bg-center rounded-[24px] flex-nowrap justify-center items-end p-8">
            <div className="absolute inset-0 bg-gradient-to-t from-[#10637C]/100  to-[#149C75]/20 rounded-[24px]"></div>
